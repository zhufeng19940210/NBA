...
- (void)calculateAllPoints
{
    ...
    [keyArray addObject:@"得分"];
    [keyArray addObject:@"投篮命中率"];
    [keyArray addObject:@"三分命中率"];
    [keyArray addObject:@"罚球命中率"];
    [keyArray addObject:@"助攻数"];
    [keyArray addObject:@"失误数"];
    NSArray *valueArray = [self getValueArrayFromDictionary:_valueDictionary keyArray:keyArray];
    _maxValue = 100;//[self getMaxValueFromValueArray:valueArray];
    ...
    int plotCircles = 5;//(_maxValue/_valueDivider);
...
- (NSArray *)getValueArrayFromDictionary:(NSDictionary *)dictionary keyArray:(NSArray *) keyArray
{
    ...
    [valueArray addObject:[dictionary valueForKey:@"得分"]];
    [valueArray addObject:[dictionary valueForKey:@"投篮命中率"]];
    [valueArray addObject:[dictionary valueForKey:@"三分命中率"]];
    [valueArray addObject:[dictionary valueForKey:@"罚球命中率"]];
    [valueArray addObject:[dictionary valueForKey:@"助攻数"]];
    [valueArray addObject:[dictionary valueForKey:@"失误数"]];
